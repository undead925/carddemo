define(function (require) {
    ...
    var real_name = $("#real_name"),
        card_id = $("#card_id"),
        sina_cash_move_submit = $("#sina_cash_move_submit"),
    ...
    $(function () {
        ...
        card_id.blur(function () {
            var value = $(this).val();
            var f = qtyd_regex.card_id_reg(value);
            if ($.trim(value) == "") {
        ...
        sina_cash_move_submit.click(function () {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result.code == 100000) {
                        layer.closeAll();
                        layer.open({
                            content: '<div class="tac"><i class="qtydfont c-success ft25">&#xe61b;</i><p class="c-999 mt5">恭喜，资金迁移成功</p></div>',
                            btn: ['好'],
                        ...
                        show_error("资金迁移失败，失败原因：" + result.msg, 3);
                        return false;
                    }
                }, error: function () {
                    show_error("资金迁移失败", 1);
